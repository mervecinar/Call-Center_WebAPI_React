...
namespace FinalBackEnd.Migrations
{
    ...
    [Migration("20230110173107_mervecinar")]
    partial class mervecinar
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinalBackEnd.Models.CosRepresantative", b =>
                {
            ...
            modelBuilder.Entity("FinalBackEnd.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("FinalBackEnd.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FinalBackEnd.Models.RequestComplaint", b =>
                {
            ...
            modelBuilder.Entity("FinalBackEnd.Models.Score", b =>
                {
                    b.Property<int>("CosRepresantativeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinalBackEnd.Models.CosRepresantative", b =>
                {
                    b.HasOne("FinalBackEnd.Models.Department", "Department")
            ...
            modelBuilder.Entity("FinalBackEnd.Models.Customer", b =>
                {
                    b.HasOne("FinalBackEnd.Models.CosRepresantative", "CosRepresantative")
                        .WithMany("Customers")
            ...
            modelBuilder.Entity("FinalBackEnd.Models.RequestComplaint", b =>
                {
                    b.HasOne("FinalBackEnd.Models.Customer", "Customer")
